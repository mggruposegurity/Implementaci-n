...
if (isset($_POST['id'])) {
    ...
    $tabla = "tbl_planilla"; // 👈 tabla del módulo
    $campo_id = "id_planilla";    // 👈 campo llave primaria
    ...
    try {
        ...
        if ($conexion->query($sql)) {
            ...
            log_event($id_usuario, "Eliminación de registro", "Se eliminó el reporte con ID $id (borrado físico)");
        ...
        log_event($id_usuario, "Eliminación de registro", "Se cambió el estado del reporte con ID $id a INACTIVO (eliminación lógica)");
