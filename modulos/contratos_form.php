...
<style>
  ...
  /* Marca de agua con el logo – usa ../imagenes/logo.jpeg */
  body::before {
    content: "";
    position: fixed;
    top: 50%;
    ...
    background: url("/imagenes/logo.jpeg") no-repeat center center;
...
<div class="page">
  ...
  <div class="logo">
    <!-- Logo del encabezado – también usa ../imagenes/logo.jpeg -->
