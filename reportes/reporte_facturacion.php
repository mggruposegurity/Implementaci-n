...
<div class="container mt-4 bg-white shadow p-4 rounded">
    ...
    <div class="mb-3 d-flex gap-3 no-print">
        ...
        <a href="reporte_facturacion.php?export=csv" class="btn btn-success">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($fila = mysqli_fetch_assoc($result)) {
                        ...
                        foreach ($fila as $campo => $dato) {
                            // Intentar formatear si es JSON para facturación
...
async function exportarPDF() {
    ...
    doc.save('facturacion_reporte_<?php echo date("Y-m-d"); ?>.pdf');
}
...
function exportarWord() {
    ...
    fileDownload.download = 'facturacion_reporte_<?php echo date("Y-m-d"); ?>.doc';
    fileDownload.click();
...
if (isset($_GET['export']) && $_GET['export'] == "csv") {
    ...
    $filename = "facturacion_reporte_" . date("Y-m-d") . ".csv";
