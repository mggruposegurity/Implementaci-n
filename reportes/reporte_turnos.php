...
<div class="container mt-4 bg-white shadow p-4 rounded">
    ...
    <div class="mb-3 d-flex gap-3 no-print">
        ...
        <a href="reporte_turnos.php?export=csv" class="btn btn-success">
...
async function exportarPDF() {
    ...
    doc.save('turnos_reporte_<?php echo date("Y-m-d"); ?>.pdf');
}
...
function exportarWord() {
    ...
    fileDownload.download = 'turnos_reporte_<?php echo date("Y-m-d"); ?>.doc';
    fileDownload.click();
...
if (isset($_GET['export']) && $_GET['export'] == "csv") {
    ...
    $filename = "turnos_reporte_" . date("Y-m-d") . ".csv";
